...
export const enableSymbolFallbackForWWW = __VARIANT__; // Enable this flag to help with concurrent mode debugging.
...
export const enableSchedulingProfiler = __VARIANT__; // This only has an effect in the new reconciler. But also, the new reconciler
...
export const deferRenderPhaseUpdateToNextBatch = !__VARIANT__; // These are already tested in both modes using the build type dimension,
// so we don't need to use __VARIANT__ to get extra coverage.

export const replayFailedUnitOfWorkWithInvokeGuardedCallback = false; // TODO: These flags are hard-coded to the default values used in open source.
...
export const allowConcurrentByDefault = true; // You probably *don't* want to add more hardcoded ones.
