...
import { enableSchedulingProfiler, enableNewReconciler, enableCache, enableUseRefAccessWarning, enableUseMutableSource, enableTransitionTracing } from '../../shared/ReactFeatureFlags';
...
import { getWorkInProgressRoot, getWorkInProgressRootRenderLanes, scheduleUpdateOnFiber, requestUpdateLane, requestEventTime, markSkippedUpdateLanes } from './ReactFiberWorkLoop.new';
import is from '../../shared/objectIs';
import { markWorkInProgressReceivedUpdate } from './ReactFiberBeginWork.new';
import { getIsHydrating } from './ReactFiberHydrationContext.new';
import { getWorkInProgressVersion, markSourceAsDirty, setWorkInProgressVersion } from './ReactMutableSource.new';
...
} = ReactSharedInternals; // These are set right before calling the component.
...
let globalClientIdCounter = 0; // In DEV, this is the name of the currently executing primitive hook
